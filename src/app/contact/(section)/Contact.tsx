              ...
              <div className="flex w-full flex-col gap-10">
                ...
                <div className="flex items-center gap-3">
                  <Button
                    ...
                    asChild
                  >
                    <Link href="https://www.instagram.com/istanbulrestaurantmanchester/?hl=en">
                      <Icons.instagram />
                    </Link>
                  </Button>
                  <Button
                    ...
                    asChild
                  >
                    <Link href="https://www.google.com/maps/place/Istanbul+Restaurant+Manchester/@53.5111071,-2.2442094,15z/data=!4m2!3m1!1s0x0:0x614d0e8514d9a215?sa=X&ved=1t:2428&ictx=111">
                      <Icons.google />
                    </Link>
                  </Button>
                  <Button
                    ...
                    asChild
                  >
                    <Link href="https://www.facebook.com/istanbulrestaurantmanchester/">
                      <Icons.facebook />
                    </Link>
                  </Button>
                </div>
